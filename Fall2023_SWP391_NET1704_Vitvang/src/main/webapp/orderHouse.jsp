...
<body>
     ...
     <!-- Link call servlet get all product in cage -->
        <c:url value="Maincontroller" var="getListCage">
            <c:param name="btAction" value="Cage list"/>
        </c:url>
        ...
        <div class="top">
            ...
            <div class="search-box">
                ...
                <input type="text" placeholder="Search here...">
                 <button class="add-btn" > <a href="${getListCage}">ADD</a></button>
            </div>
            ...
            <div class="overview">
                ...
                <div class="boxes">
                    <div class="box box1">
                        ...
                        <span class="text">Tong donn Hang</span>
                        <span class="number">4000</span>
                    </div>
                    <div class="box box2">
                       <i class="uil uil-analysis"></i>
                        <span class="text">Dang Thuc hien</span>
                        <span class="number">3000</span>
                    </div>
                    <div class="box box3">
                         <i class="uil uil-truck-loading"></i>
                        <span class="text">Dang Van Chuyen</span>
