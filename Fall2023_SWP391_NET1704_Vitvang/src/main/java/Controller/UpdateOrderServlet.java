...
public class UpdateOrderServlet extends HttpServlet {
        ...
        protected void processRequest(HttpServletRequest request, HttpServletResponse response)
                ...
                String StatusProcess = request.getParameter("txtStatusProcess");
...
//                                request.setAttribute("UPDATE_ERRORS", errors);
                                ...
                                boolean result = dao.updateOrder(OrderID, productStartDate, productEndDate, productQuantity, productPrice, Delivery, Address, StatusProcess, StaffID);
                                ...
                                if (result) {
                                        ...
                                        request.setAttribute("msg", "Update account '" + OrderID + "' Sucess!");
